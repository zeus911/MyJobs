...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'registration_invitation', (
            ...
            ('added_permission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True)),
            ('added_saved_search', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mysearches.SavedSearch'], null=True, blank=True)),
    ...
    models = {
        ...
        u'registration.invitation': {
            ...
            'added_permission': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Group']", 'null': 'True', 'blank': 'True'}),
            'added_saved_search': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mysearches.SavedSearch']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
