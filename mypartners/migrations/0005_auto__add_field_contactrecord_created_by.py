...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactRecord.created_by'
        db.add_column(u'mypartners_contactrecord', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myjobs.User'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactRecord.created_by'
        db.delete_column(u'mypartners_contactrecord', 'created_by_id')
