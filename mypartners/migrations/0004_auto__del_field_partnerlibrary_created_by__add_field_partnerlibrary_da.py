...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PartnerLibrary.created_by'
        db.delete_column(u'mypartners_partnerlibrary', 'created_by')

        # Adding field 'PartnerLibrary.data_source'
        db.add_column(u'mypartners_partnerlibrary', 'data_source',
                      self.gf('django.db.models.fields.CharField')(default='Employment Referral Resource Directory', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PartnerLibrary.created_by'
        db.add_column(u'mypartners_partnerlibrary', 'created_by',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'PartnerLibrary.data_source'
        db.delete_column(u'mypartners_partnerlibrary', 'data_source')
