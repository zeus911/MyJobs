...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartnerLibrary.area'
        db.alter_column(u'mypartners_partnerlibrary', 'area', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'PartnerLibrary.area'
        db.alter_column(u'mypartners_partnerlibrary', 'area', self.gf('django.db.models.fields.CharField')(max_length=30))
