...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactLogEntry.delta'
        db.add_column(u'mypartners_contactlogentry', 'delta',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactLogEntry.delta'
        db.delete_column(u'mypartners_contactlogentry', 'delta')
