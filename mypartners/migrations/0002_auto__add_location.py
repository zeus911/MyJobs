...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field locations on 'Contact'
        m2m_table_name = db.shorten_name(u'mypartners_contact_locations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contact', models.ForeignKey(orm[u'mypartners.contact'], null=False)),
            ('location', models.ForeignKey(orm[u'mypartners.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['contact_id', 'location_id'])


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table(u'mypartners_location')

        # Removing M2M table for field locations on 'Contact'
        db.delete_table(db.shorten_name(u'mypartners_contact_locations'))
