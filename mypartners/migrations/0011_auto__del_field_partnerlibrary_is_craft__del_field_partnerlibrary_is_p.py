...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PartnerLibrary.is_craft'
        db.delete_column(u'mypartners_partnerlibrary', 'is_craft')

        # Deleting field 'PartnerLibrary.is_professional'
        db.delete_column(u'mypartners_partnerlibrary', 'is_professional')

        # Deleting field 'PartnerLibrary.is_exec_om'
        db.delete_column(u'mypartners_partnerlibrary', 'is_exec_om')

        # Deleting field 'PartnerLibrary.is_service'
        db.delete_column(u'mypartners_partnerlibrary', 'is_service')

        # Deleting field 'PartnerLibrary.is_first_om'
        db.delete_column(u'mypartners_partnerlibrary', 'is_first_om')

        # Deleting field 'PartnerLibrary.is_operative'
        db.delete_column(u'mypartners_partnerlibrary', 'is_operative')

        # Deleting field 'PartnerLibrary.is_labor'
        db.delete_column(u'mypartners_partnerlibrary', 'is_labor')

        # Deleting field 'PartnerLibrary.is_technician'
        db.delete_column(u'mypartners_partnerlibrary', 'is_technician')

        # Deleting field 'PartnerLibrary.is_sales'
        db.delete_column(u'mypartners_partnerlibrary', 'is_sales')

        # Deleting field 'PartnerLibrary.is_admin_support'
        db.delete_column(u'mypartners_partnerlibrary', 'is_admin_support')


    def backwards(self, orm):
        # Adding field 'PartnerLibrary.is_craft'
        db.add_column(u'mypartners_partnerlibrary', 'is_craft',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerLibrary.is_professional'
        db.add_column(u'mypartners_partnerlibrary', 'is_professional',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerLibrary.is_exec_om'
        db.add_column(u'mypartners_partnerlibrary', 'is_exec_om',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerLibrary.is_service'
        db.add_column(u'mypartners_partnerlibrary', 'is_service',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerLibrary.is_first_om'
        db.add_column(u'mypartners_partnerlibrary', 'is_first_om',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerLibrary.is_operative'
        db.add_column(u'mypartners_partnerlibrary', 'is_operative',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerLibrary.is_labor'
        db.add_column(u'mypartners_partnerlibrary', 'is_labor',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerLibrary.is_technician'
        db.add_column(u'mypartners_partnerlibrary', 'is_technician',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerLibrary.is_sales'
        db.add_column(u'mypartners_partnerlibrary', 'is_sales',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PartnerLibrary.is_admin_support'
        db.add_column(u'mypartners_partnerlibrary', 'is_admin_support',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'mypartners.partner': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'library_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mypartners.PartnerLibrary']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'mypartners.partnerlibrary': {
            ...
            'st': ('django.db.models.fields.CharField', [], {'max_length': '5', 'blank': 'True'}),
