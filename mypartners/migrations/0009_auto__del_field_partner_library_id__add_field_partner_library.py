...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Partner.library_id'
        db.delete_column(u'mypartners_partner', 'library_id_id')

        # Adding field 'Partner.library'
        db.add_column(u'mypartners_partner', 'library',
    ...
    def backwards(self, orm):
        # Adding field 'Partner.library_id'
        db.add_column(u'mypartners_partner', 'library_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mypartners.PartnerLibrary'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)

        # Deleting field 'Partner.library'
        db.delete_column(u'mypartners_partner', 'library_id')
