...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'mypartners_contact', 'city')

        # Deleting field 'Contact.state'
        db.delete_column(u'mypartners_contact', 'state')

        # Deleting field 'Contact.postal_code'
        db.delete_column(u'mypartners_contact', 'postal_code')
        ...
        # Deleting field 'Contact.address_line_two'
        db.delete_column(u'mypartners_contact', 'address_line_two')


    def backwards(self, orm):
        # Adding field 'Contact.city'
        db.add_column(u'mypartners_contact', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Contact.state'
        db.add_column(u'mypartners_contact', 'state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'Contact.postal_code'
        db.add_column(u'mypartners_contact', 'postal_code',
        ...
        db.add_column(u'mypartners_contact', 'address_line_one',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Contact.address_line_two'
        db.add_column(u'mypartners_contact', 'address_line_two',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
