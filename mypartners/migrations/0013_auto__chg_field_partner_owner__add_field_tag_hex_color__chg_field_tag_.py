...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Partner.owner'
        db.alter_column(u'mypartners_partner', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Company']))
        # Adding field 'Tag.hex_color'
        db.add_column(u'mypartners_tag', 'hex_color',
                      self.gf('django.db.models.fields.CharField')(default='d4d4d4', max_length=6, blank=True),
                      keep_default=False)


        # Changing field 'Tag.company'
        db.alter_column(u'mypartners_tag', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Company']))

    def backwards(self, orm):

        # Changing field 'Partner.owner'
        db.alter_column(u'mypartners_partner', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mydashboard.Company']))
        # Deleting field 'Tag.hex_color'
        db.delete_column(u'mypartners_tag', 'hex_color')


        # Changing field 'Tag.company'
        db.alter_column(u'mypartners_tag', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mydashboard.Company']))
