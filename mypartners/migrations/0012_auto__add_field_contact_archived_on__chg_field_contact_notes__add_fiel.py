...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mypartners_contact', 'notes', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))
        # Adding field 'ContactRecord.contact'
        db.add_column(u'mypartners_contactrecord', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mypartners.Contact'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Contact.notes'
        db.alter_column(u'mypartners_contact', 'notes', self.gf('django.db.models.fields.TextField')(default='', max_length=1000))
    ...
    models = {
        ...
        u'mypartners.contact': {
            ...
            'notes': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
