...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerLibrary.is_disabled_veteran'
        db.add_column(u'mypartners_partnerlibrary', 'is_disabled_veteran',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerLibrary.is_disabled_veteran'
        db.delete_column(u'mypartners_partnerlibrary', 'is_disabled_veteran')
