...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartnerLibrary.st'
        db.alter_column(u'mypartners_partnerlibrary', 'st', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'PartnerLibrary.st'
        db.alter_column(u'mypartners_partnerlibrary', 'st', self.gf('django.db.models.fields.CharField')(max_length=5))
