...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactRecord.contact_type'
        db.alter_column(u'mypartners_contactrecord', 'contact_type', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'ContactRecord.contact_type'
        db.alter_column(u'mypartners_contactrecord', 'contact_type', self.gf('django.db.models.fields.CharField')(max_length=12))
