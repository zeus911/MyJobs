...
class OFCCPContact(models.Model):
    """ Office of Federal Contract Compliance Programs (OFCCP) contacts.
        ...
        .. note:: For the differences between `state` and `st`, see the ofccp
                  module.
    """
    # The person who created the contact. Thos generated by the `manage
    # update_ofccps` command are tagged said to be created by
    # directemployers.org
    ...
    # Job Categories
    is_exec_om = models.BooleanField('exec_om', default=False)
    is_first_om = models.BooleanField('first_om', default=False)
    is_professional = models.BooleanField('professional', default=False)
    is_technician = models.BooleanField('technician', default=False)
    is_sales =  models.BooleanField('sales', default=False)
    is_admin_support =  models.BooleanField('admin_support', default=False)
    is_craft = models.BooleanField('craft', default=False)
    is_operative = models.BooleanField('operative', default=False)
    is_labor = models.BooleanField('labor', default=False)
