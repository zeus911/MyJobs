...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'postajob_companyprofile_customer_of', (
        ...
        db.create_unique(u'postajob_companyprofile_customer_of', ['companyprofile_id', 'company_id'])


    def backwards(self, orm):
        # Removing M2M table for field customer_of on 'CompanyProfile'
        db.delete_table('postajob_companyprofile_customer_of')
