...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'postajob_joblocation', (
        ...
        db.send_create_signal(u'postajob', ['JobLocation'])
        ...
        db.create_table(u'postajob_job', (
            ...
            ('apply_link', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('apply_info', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        m2m_table_name = db.shorten_name(u'postajob_job_site_packages')
        ...
        db.create_unique(m2m_table_name, ['job_id', 'sitepackage_id'])

        # Adding M2M table for field locations on 'Job'
        m2m_table_name = db.shorten_name(u'postajob_job_locations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('job', models.ForeignKey(orm[u'postajob.job'], null=False)),
            ('joblocation', models.ForeignKey(orm[u'postajob.joblocation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['job_id', 'joblocation_id'])
        ...
        db.create_table(u'postajob_sitepackage', (
            (u'package_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['postajob.Package'], unique=True, primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Company'], null=True, blank=True)),
        ))
        db.send_create_signal(u'postajob', ['SitePackage'])

        # Adding M2M table for field sites on 'SitePackage'
        m2m_table_name = db.shorten_name(u'postajob_sitepackage_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sitepackage', models.ForeignKey(orm[u'postajob.sitepackage'], null=False)),
            ('seosite', models.ForeignKey(orm[u'seo.seosite'], null=False))
        ))
        db.create_unique(m2m_table_name, ['sitepackage_id', 'seosite_id'])
        ...
        db.create_table(u'postajob_purchasedproduct', (
            ...
            ('offline_purchase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postajob.OfflinePurchase'], null=True, blank=True)),
            ...
            ('max_job_length', self.gf('django.db.models.fields.IntegerField')()),
            ('jobs_remaining', self.gf('django.db.models.fields.IntegerField')()),
        ))
        ...
        db.create_table(u'postajob_product', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postajob.Package'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Company'])),
            ...
            ('max_job_length', self.gf('django.db.models.fields.PositiveIntegerField')(default=30)),
            ('num_jobs_allowed', self.gf('django.db.models.fields.PositiveIntegerField')(default=5)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('featured', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('requires_approval', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.create_table(u'postajob_companyprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['seo.Company'], unique=True)),
            ...
            ('email_on_request', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('outgoing_email_domain', self.gf('django.db.models.fields.CharField')(default='my.jobs', max_length=255)),
        ))
        ...
        db.create_table(u'postajob_request', (
            ...
            ('made_on', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Company'])),
        ))
        ...
        db.create_table(u'postajob_offlinepurchase', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Company'])),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postajob.Invoice'], null=True)),
            ('redemption_uid', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created', to=orm['seo.CompanyUser'])),
            ('created_on', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('redeemed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='redeemed', null=True, to=orm['seo.CompanyUser'])),
        ...
        db.create_table(u'postajob_invoice', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owner', to=orm['seo.Company'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'postajob_joblocation')

        # Deleting model 'Job'
        db.delete_table(u'postajob_job')

        # Removing M2M table for field site_packages on 'Job'
        db.delete_table(db.shorten_name(u'postajob_job_site_packages'))

        # Removing M2M table for field locations on 'Job'
        db.delete_table(db.shorten_name(u'postajob_job_locations'))
        ...
        db.delete_table(db.shorten_name(u'postajob_sitepackage_sites'))
