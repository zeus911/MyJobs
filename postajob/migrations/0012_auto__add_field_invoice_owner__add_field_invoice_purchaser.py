...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.owner'
        db.add_column(u'postajob_invoice', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='owner', to=orm['mydashboard.Company']),
                      keep_default=False)

        # Adding field 'Invoice.purchaser'
        db.add_column(u'postajob_invoice', 'purchaser',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='purchaser', to=orm['mydashboard.Company']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.owner'
        db.delete_column(u'postajob_invoice', 'owner_id')

        # Deleting field 'Invoice.purchaser'
        db.delete_column(u'postajob_invoice', 'purchaser_id')
    ...
    models = {
        ...
        u'postajob.invoice': {
            ...
            'purchaser': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'purchaser'", 'to': u"orm['mydashboard.Company']"}),
