...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.date_updated'
        db.alter_column(u'postajob_job', 'date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Job.date_new'
        db.alter_column(u'postajob_job', 'date_new', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Job.date_updated'
        db.alter_column(u'postajob_job', 'date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Job.date_new'
        db.alter_column(u'postajob_job', 'date_new', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'postajob.job': {
            ...
            'date_new': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
