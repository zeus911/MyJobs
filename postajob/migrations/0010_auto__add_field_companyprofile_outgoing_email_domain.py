...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.outgoing_email_domain'
        db.add_column(u'postajob_companyprofile', 'outgoing_email_domain',
                      self.gf('django.db.models.fields.CharField')(default='my.jobs', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.outgoing_email_domain'
        db.delete_column(u'postajob_companyprofile', 'outgoing_email_domain')
