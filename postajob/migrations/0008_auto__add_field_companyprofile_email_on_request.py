...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.email_on_request'
        db.add_column(u'postajob_companyprofile', 'email_on_request',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.email_on_request'
        db.delete_column(u'postajob_companyprofile', 'email_on_request')
