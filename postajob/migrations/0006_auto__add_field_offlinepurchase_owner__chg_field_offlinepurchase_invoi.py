...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfflinePurchase.owner'
        db.add_column(u'postajob_offlinepurchase', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mydashboard.Company']),
                      keep_default=False)


        # Changing field 'OfflinePurchase.invoice'
        db.alter_column(u'postajob_offlinepurchase', 'invoice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postajob.Invoice'], null=True))
        # Adding field 'PurchasedProduct.offline_purchase'
        db.add_column(u'postajob_purchasedproduct', 'offline_purchase',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postajob.OfflinePurchase'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfflinePurchase.owner'
        db.delete_column(u'postajob_offlinepurchase', 'owner_id')


        # Changing field 'OfflinePurchase.invoice'
        db.alter_column(u'postajob_offlinepurchase', 'invoice_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['postajob.Invoice']))
        # Deleting field 'PurchasedProduct.offline_purchase'
        db.delete_column(u'postajob_purchasedproduct', 'offline_purchase_id')
