...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyProfile.company'
        db.alter_column(u'postajob_companyprofile', 'company_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mydashboard.Company'], unique=True))
        # Adding unique constraint on 'CompanyProfile', fields ['company']
        db.create_unique(u'postajob_companyprofile', ['company_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompanyProfile', fields ['company']
        db.delete_unique(u'postajob_companyprofile', ['company_id'])


        # Changing field 'CompanyProfile.company'
        db.alter_column(u'postajob_companyprofile', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mydashboard.Company']))
