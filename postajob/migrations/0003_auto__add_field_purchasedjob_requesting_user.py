...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field blocked_users on 'CompanyProfile'
        m2m_table_name = db.shorten_name(u'postajob_companyprofile_blocked_users')
        ...
        db.create_unique(m2m_table_name, ['companyprofile_id', 'user_id'])

        # Adding field 'PurchasedJob.requesting_user'
        db.add_column(u'postajob_purchasedjob', 'requesting_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myjobs.User'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Removing M2M table for field blocked_users on 'CompanyProfile'
        db.delete_table(db.shorten_name(u'postajob_companyprofile_blocked_users'))

        # Deleting field 'PurchasedJob.requesting_user'
        db.delete_column(u'postajob_purchasedjob', 'requesting_user_id')
    ...
    models = {
        ...
        u'postajob.purchasedjob': {
            ...
            'requesting_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['myjobs.User']", 'null': 'True', 'on_delete': 'models.SET_NULL'})
        },
