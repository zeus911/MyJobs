...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OfflinePurchase.invoice'
        db.add_column(u'postajob_offlinepurchase', 'invoice',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'OfflinePurchase.invoice'
        db.delete_column(u'postajob_offlinepurchase', 'invoice_id')
