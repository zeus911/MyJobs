...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'postajob_joblocation', (
            ...
            ('state_short', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('country_short', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('zipcode', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
        ))
        db.send_create_signal(u'postajob', ['JobLocation'])

        # Deleting field 'Job.country_short'
        db.delete_column(u'postajob_job', 'country_short')

        # Deleting field 'Job.zipcode'
        db.delete_column(u'postajob_job', 'zipcode')

        # Deleting field 'Job.guid'
        db.delete_column(u'postajob_job', 'guid')

        # Deleting field 'Job.city'
        db.delete_column(u'postajob_job', 'city')

        # Deleting field 'Job.state'
        db.delete_column(u'postajob_job', 'state')

        # Deleting field 'Job.state_short'
        db.delete_column(u'postajob_job', 'state_short')

        # Deleting field 'Job.country'
        db.delete_column(u'postajob_job', 'country')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Job.country_short'
        db.add_column(u'postajob_job', 'country_short',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)

        # Adding field 'Job.zipcode'
        db.add_column(u'postajob_job', 'zipcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)

        # Adding field 'Job.guid'
        db.add_column(u'postajob_job', 'guid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True),
                      keep_default=False)

        # Adding field 'Job.city'
        db.add_column(u'postajob_job', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Job.state'
        db.add_column(u'postajob_job', 'state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Job.state_short'
        db.add_column(u'postajob_job', 'state_short',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)

        # Adding field 'Job.country'
        db.add_column(u'postajob_job', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        u'postajob.job': {
            ...
            'locations': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['postajob.JobLocation']", 'symmetrical': 'False'}),
