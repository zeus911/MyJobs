...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field related_sites on 'Request'
        m2m_table_name = db.shorten_name(u'postajob_request_related_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('request', models.ForeignKey(orm[u'postajob.request'], null=False)),
            ('seosite', models.ForeignKey(orm[u'seo.seosite'], null=False))
        ))
        db.create_unique(m2m_table_name, ['request_id', 'seosite_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_sites on 'Request'
        db.delete_table(db.shorten_name(u'postajob_request_related_sites'))
