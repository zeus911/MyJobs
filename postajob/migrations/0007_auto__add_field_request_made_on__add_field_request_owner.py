...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.made_on'
        db.add_column(u'postajob_request', 'made_on',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 7, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Request.owner'
        db.add_column(u'postajob_request', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mydashboard.Company']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.made_on'
        db.delete_column(u'postajob_request', 'made_on')

        # Deleting field 'Request.owner'
        db.delete_column(u'postajob_request', 'owner_id')
