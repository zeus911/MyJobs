...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_links_sociallink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('link_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('link_title', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('link_type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('link_icon', self.gf('django.db.models.fields.CharField')(default='default', max_length=30)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True)),
        ))
        db.send_create_signal('social_links', ['SocialLink'])

        # Adding M2M table for field sites on 'SocialLink'
        db.create_table('social_links_sociallink_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sociallink', models.ForeignKey(orm['social_links.sociallink'], null=False)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False))
        ))
        db.create_unique('social_links_sociallink_sites', ['sociallink_id', 'seosite_id'])


    def backwards(self, orm):
        
        # Deleting model 'SocialLink'
        db.delete_table('social_links_sociallink')

        # Removing M2M table for field sites on 'SocialLink'
        db.delete_table('social_links_sociallink_sites')
