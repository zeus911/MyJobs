...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'social_links_sociallinktype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60)),
            ('icon', self.gf('django.db.models.fields.files.FileField')(max_length=767)),
        ))
        db.send_create_signal(u'social_links', ['SocialLinkType'])
        ...
        db.create_table(u'social_links_sociallink', (
            ...
            ('link_title', self.gf('django.db.models.fields.CharField')(max_length=60, db_index=True)),
            ('link_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('link_icon', self.gf('django.db.models.fields.CharField')(default='default', max_length=255)),
        ...
        # Adding M2M table for field sites on 'SocialLink'
        m2m_table_name = db.shorten_name(u'social_links_sociallink_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sociallink', models.ForeignKey(orm[u'social_links.sociallink'], null=False)),
            ('seosite', models.ForeignKey(orm[u'seo.seosite'], null=False))
        ))
        db.create_unique(m2m_table_name, ['sociallink_id', 'seosite_id'])

        # Adding model 'MicrositeCarousel'
        db.create_table(u'social_links_micrositecarousel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('include_all_sites', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True)),
            ('display_rows', self.gf('django.db.models.fields.IntegerField')()),
            ('carousel_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'social_links', ['MicrositeCarousel'])

        # Adding M2M table for field link_sites on 'MicrositeCarousel'
        m2m_table_name = db.shorten_name(u'social_links_micrositecarousel_link_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('micrositecarousel', models.ForeignKey(orm[u'social_links.micrositecarousel'], null=False)),
            ('seosite', models.ForeignKey(orm[u'seo.seosite'], null=False))
        ))
        db.create_unique(m2m_table_name, ['micrositecarousel_id', 'seosite_id'])


    def backwards(self, orm):
        # Deleting model 'SocialLinkType'
        db.delete_table(u'social_links_sociallinktype')

        # Deleting model 'SocialLink'
        db.delete_table(u'social_links_sociallink')

        # Removing M2M table for field sites on 'SocialLink'
        db.delete_table(db.shorten_name(u'social_links_sociallink_sites'))

        # Deleting model 'MicrositeCarousel'
        db.delete_table(u'social_links_micrositecarousel')

        # Removing M2M table for field link_sites on 'MicrositeCarousel'
        db.delete_table(db.shorten_name(u'social_links_micrositecarousel_link_sites'))
    ...
    models = {
        ...
        u'social_links.sociallinktype': {
            'Meta': {'object_name': 'SocialLinkType'},
            'icon': ('django.db.models.fields.files.FileField', [], {'max_length': '767'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '60'})
        }
    }
