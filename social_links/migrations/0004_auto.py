...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SocialLink', fields ['link_title']
        db.create_index('social_links_sociallink', ['link_title'])


    def backwards(self, orm):
        # Removing index on 'SocialLink', fields ['link_title']
        db.delete_index('social_links_sociallink', ['link_title'])
