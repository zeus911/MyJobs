...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialLink.link_icon'
        db.alter_column('social_links_sociallink', 'link_icon', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'SocialLink.link_type'
        db.alter_column('social_links_sociallink', 'link_type', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'SocialLink.link_icon'
        db.alter_column('social_links_sociallink', 'link_icon', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'SocialLink.link_type'
        db.alter_column('social_links_sociallink', 'link_type', self.gf('django.db.models.fields.CharField')(max_length=30))
