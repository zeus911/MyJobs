...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_links_micrositecarousel', (
        ...
        db.send_create_signal('social_links', ['MicrositeCarousel'])

        # Adding M2M table for field link_sites on 'MicrositeCarousel'
        db.create_table('social_links_micrositecarousel_link_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('micrositecarousel', models.ForeignKey(orm['social_links.micrositecarousel'], null=False)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False))
        ))
        db.create_unique('social_links_micrositecarousel_link_sites', ['micrositecarousel_id', 'seosite_id'])


    def backwards(self, orm):
        
        # Deleting model 'MicrositeCarousel'
        db.delete_table('social_links_micrositecarousel')

        # Removing M2M table for field link_sites on 'MicrositeCarousel'
        db.delete_table('social_links_micrositecarousel_link_sites')
