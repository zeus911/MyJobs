...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailSection'
        db.create_table(u'myemails_emailsection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('section_type', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'myemails', ['EmailSection'])

        # Adding model 'EmailTemplate'
        db.create_table(u'myemails_emailtemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('header', self.gf('django.db.models.fields.related.ForeignKey')(related_name='header_for', to=orm['myemails.EmailSection'])),
            ('body', self.gf('django.db.models.fields.related.ForeignKey')(related_name='body_for', to=orm['myemails.EmailSection'])),
            ('footer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='footer_for', to=orm['myemails.EmailSection'])),
        ))
        db.send_create_signal(u'myemails', ['EmailTemplate'])

        # Adding model 'CronEvent'
        db.create_table(u'myemails_cronevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True)),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('minutes', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'myemails', ['CronEvent'])

        # Adding model 'ValueEvent'
        db.create_table(u'myemails_valueevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myemails.EmailTemplate'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Company'])),
            ('compare_using', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'myemails', ['ValueEvent'])
    ...
    def backwards(self, orm):
        # Deleting model 'EmailSection'
        db.delete_table(u'myemails_emailsection')

        # Deleting model 'EmailTemplate'
        db.delete_table(u'myemails_emailtemplate')

        # Deleting model 'CronEvent'
        db.delete_table(u'myemails_cronevent')

        # Deleting model 'ValueEvent'
        db.delete_table(u'myemails_valueevent')
    ...
    models = {
        ...
        u'myemails.cronevent': {
            ...
            'model': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
