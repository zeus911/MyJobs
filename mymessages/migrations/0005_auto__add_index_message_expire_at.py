...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Message', fields ['expire_at']
        db.create_index(u'mymessages_message', ['expire_at'])


    def backwards(self, orm):
        # Removing index on 'Message', fields ['expire_at']
        db.delete_index(u'mymessages_message', ['expire_at'])
    ...
    models = {
        ...
        u'mymessages.message': {
            ...
            'expire_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 16, 0, 0)', 'null': 'True', 'db_index': 'True'}),
            ...
            'start_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 2, 0, 0)'}),
