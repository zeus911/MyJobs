...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'jobListing.onet_title'
        db.delete_column('seo_joblisting', 'onet_title')

        # Deleting field 'jobListing.f_onet_title'
        db.delete_column('seo_joblisting', 'f_onet_title')

        # Deleting field 'jobListing.onetTitleSlug'
        db.delete_column('seo_joblisting', 'onetTitleSlug')

        # Adding field 'jobListing.onet'
        db.add_column('seo_joblisting', 'onet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Onet'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'jobListing.onet_title'
        db.add_column('seo_joblisting', 'onet_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'jobListing.f_onet_title'
        db.add_column('seo_joblisting', 'f_onet_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'jobListing.onetTitleSlug'
        db.add_column('seo_joblisting', 'onetTitleSlug', self.gf('django.db.models.fields.SlugField')(blank=True, max_length=200, null=True, db_index=True), keep_default=False)

        # Deleting field 'jobListing.onet'
        db.delete_column('seo_joblisting', 'onet_id')
