...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('django_site', 'domain', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True))

    def backwards(self, orm):
        db.alter_column('django_site', 'domain', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True))
