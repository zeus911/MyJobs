...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BusinessUnit.associated_jobs'
        db.add_column('seo_businessunit', 'associated_jobs', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
        ...
        # Adding field 'Configuration.default_blurb_always_show'
        db.add_column('seo_configuration', 'default_blurb_always_show', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BusinessUnit.associated_jobs'
        db.delete_column('seo_businessunit', 'associated_jobs')

        # Deleting field 'BusinessUnit.scheduled'
        db.delete_column('seo_businessunit', 'scheduled')

        # Deleting field 'Configuration.default_blurb_always_show'
        db.delete_column('seo_configuration', 'default_blurb_always_show')
