...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Configuration.browse_facet_default'
        db.delete_column('seo_configuration', 'browse_facet_default')

        # Deleting field 'Configuration.browse_country_default'
        db.delete_column('seo_configuration', 'browse_country_default')

        # Deleting field 'Configuration.browse_city_default'
        db.delete_column('seo_configuration', 'browse_city_default')

        # Deleting field 'Configuration.browse_state_default'
        db.delete_column('seo_configuration', 'browse_state_default')

        # Deleting field 'Configuration.browse_title_default'
        db.delete_column('seo_configuration', 'browse_title_default')


    def backwards(self, orm):
        
        # Adding field 'Configuration.browse_facet_default'
        db.add_column('seo_configuration', 'browse_facet_default', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Configuration.browse_country_default'
        db.add_column('seo_configuration', 'browse_country_default', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Configuration.browse_city_default'
        db.add_column('seo_configuration', 'browse_city_default', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Configuration.browse_state_default'
        db.add_column('seo_configuration', 'browse_state_default', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Configuration.browse_title_default'
        db.add_column('seo_configuration', 'browse_title_default', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
