...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.moc_label'
        db.add_column(u'seo_configuration', 'moc_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Configuration.what_label'
        db.add_column(u'seo_configuration', 'what_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Configuration.where_label'
        db.add_column(u'seo_configuration', 'where_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Configuration.moc_placeholder'
        db.add_column(u'seo_configuration', 'moc_placeholder',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Configuration.what_placeholder'
        db.add_column(u'seo_configuration', 'what_placeholder',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Configuration.where_placeholder'
        db.add_column(u'seo_configuration', 'where_placeholder',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Configuration.moc_helptext'
        db.add_column(u'seo_configuration', 'moc_helptext',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Configuration.what_helptext'
        db.add_column(u'seo_configuration', 'what_helptext',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Configuration.where_helptext'
        db.add_column(u'seo_configuration', 'where_helptext',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.moc_label'
        db.delete_column(u'seo_configuration', 'moc_label')

        # Deleting field 'Configuration.what_label'
        db.delete_column(u'seo_configuration', 'what_label')

        # Deleting field 'Configuration.where_label'
        db.delete_column(u'seo_configuration', 'where_label')

        # Deleting field 'Configuration.moc_placeholder'
        db.delete_column(u'seo_configuration', 'moc_placeholder')

        # Deleting field 'Configuration.what_placeholder'
        db.delete_column(u'seo_configuration', 'what_placeholder')

        # Deleting field 'Configuration.where_placeholder'
        db.delete_column(u'seo_configuration', 'where_placeholder')

        # Deleting field 'Configuration.moc_helptext'
        db.delete_column(u'seo_configuration', 'moc_helptext')

        # Deleting field 'Configuration.what_helptext'
        db.delete_column(u'seo_configuration', 'what_helptext')

        # Deleting field 'Configuration.where_helptext'
        db.delete_column(u'seo_configuration', 'where_helptext')
