...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'facet.always_show'
        db.add_column('seo_facet', 'always_show', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'facet.always_show'
        db.delete_column('seo_facet', 'always_show')
    ...
    models = {
        ...
        'seo.facet': {
            ...
            'always_show': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
