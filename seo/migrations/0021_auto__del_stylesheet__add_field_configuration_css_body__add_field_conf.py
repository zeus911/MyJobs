...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuration.css_body'
        db.add_column('seo_configuration', 'css_body', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Configuration.useCssBody'
        db.add_column('seo_configuration', 'useCssBody', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Configuration.backgroundColor'
        db.add_column('seo_configuration', 'backgroundColor', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'Configuration.fontColor'
        db.add_column('seo_configuration', 'fontColor', self.gf('django.db.models.fields.CharField')(default='666666', max_length=6), keep_default=False)

        # Adding field 'Configuration.primaryColor'
        db.add_column('seo_configuration', 'primaryColor', self.gf('django.db.models.fields.CharField')(default='990000', max_length=6), keep_default=False)

        # Adding field 'Configuration.secondaryColor'
        db.add_column('seo_configuration', 'secondaryColor', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Configuration.css_body'
        db.delete_column('seo_configuration', 'css_body')

        # Deleting field 'Configuration.useCssBody'
        db.delete_column('seo_configuration', 'useCssBody')

        # Deleting field 'Configuration.backgroundColor'
        db.delete_column('seo_configuration', 'backgroundColor')

        # Deleting field 'Configuration.fontColor'
        db.delete_column('seo_configuration', 'fontColor')

        # Deleting field 'Configuration.primaryColor'
        db.delete_column('seo_configuration', 'primaryColor')

        # Deleting field 'Configuration.secondaryColor'
        db.delete_column('seo_configuration', 'secondaryColor')
