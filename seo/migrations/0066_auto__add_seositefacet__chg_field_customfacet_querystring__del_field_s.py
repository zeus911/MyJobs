...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seo_seositefacet', (
        ...
        db.send_create_signal('seo', ['SeoSiteFacet'])

        # Changing field 'CustomFacet.querystring'
        db.alter_column('seo_customfacet', 'querystring', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Deleting field 'SeoSite.default_facet'
        db.delete_column('seo_seosite', 'default_facet_id')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('seo_seositefacet')

        # Changing field 'CustomFacet.querystring'
        db.alter_column('seo_customfacet', 'querystring', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

        # Adding field 'SeoSite.default_facet'
        db.add_column('seo_seosite', 'default_facet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='filtered_sites', null=True, to=orm['seo.facet'], blank=True), keep_default=False)
