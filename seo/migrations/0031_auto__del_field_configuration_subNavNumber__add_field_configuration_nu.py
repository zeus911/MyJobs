...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rname field 'Configuration.subNavNumber'
        db.rename_column('seo_configuration', 'subNavNumber', 'num_subnav_items_to_show')


    def backwards(self, orm):

        # Rename field 'Configuration.num_subnav_items_to_show'
        db.rename_column('seo_configuration', 'num_subnav_items_to_show', 'subNavNumber')
