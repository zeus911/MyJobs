...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillboardHotspot.display_url'
        db.add_column('seo_billboardhotspot', 'display_url', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillboardHotspot.display_url'
        db.delete_column('seo_billboardhotspot', 'display_url')
