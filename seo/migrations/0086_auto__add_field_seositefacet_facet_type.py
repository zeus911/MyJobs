...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SeoSiteFacet.facet_type'
        db.add_column('seo_seositefacet', 'facet_type', self.gf('django.db.models.fields.CharField')(default='STD', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SeoSiteFacet.facet_type'
        db.delete_column('seo_seositefacet', 'facet_type')
