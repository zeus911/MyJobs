...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'jobListing.buid' to match new field type.
        db.rename_column('seo_joblisting', 'buid', 'buid_id')
        # Changing field 'jobListing.buid'
        db.alter_column('seo_joblisting', 'buid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.BusinessUnit']))

        # Adding index on 'jobListing', fields ['buid']
        db.create_index('seo_joblisting', ['buid_id'])


    def backwards(self, orm):
        
        # Removing index on 'jobListing', fields ['buid']
        db.delete_index('seo_joblisting', ['buid_id'])

        # Renaming column for 'jobListing.buid' to match new field type.
        db.rename_column('seo_joblisting', 'buid_id', 'buid')
        # Changing field 'jobListing.buid'
        db.alter_column('seo_joblisting', 'buid', self.gf('django.db.models.fields.IntegerField')())
