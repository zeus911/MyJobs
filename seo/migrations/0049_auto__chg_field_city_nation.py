...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'City.nation'
        db.alter_column('seo_city', 'nation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.State']))


    def backwards(self, orm):
        
        # Changing field 'City.nation'
        db.alter_column('seo_city', 'nation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Country']))
    ...
    models = {
        ...
        'seo.city': {
            ...
            'nation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['seo.State']"})
        },
        'seo.configuration': {
