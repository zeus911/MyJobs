...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seo_billboardimage', (
        ...
        db.send_create_signal('seo', ['BillboardImage'])

        # Adding M2M table for field billboard_images on 'SeoSite'
        db.create_table('seo_seosite_billboard_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('billboardimage', models.ForeignKey(orm['seo.billboardimage'], null=False))
        ))
        db.create_unique('seo_seosite_billboard_images', ['seosite_id', 'billboardimage_id'])


    def backwards(self, orm):
        
        # Deleting model 'BillboardImage'
        db.delete_table('seo_billboardimage')

        # Removing M2M table for field billboard_images on 'SeoSite'
        db.delete_table('seo_seosite_billboard_images')
    ...
    models = {
        ...
        'seo.configuration': {
            ...
            'home_page_template': ('django.db.models.fields.CharField', [], {'default': "'home_page_listing.html'", 'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
