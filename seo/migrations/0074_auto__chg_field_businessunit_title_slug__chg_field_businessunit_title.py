...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('seo_businessunit', 'title_slug', self.gf('django.db.models.fields.SlugField')(max_length=500, null=True))

        # Changing field 'BusinessUnit.title'
        db.alter_column('seo_businessunit', 'title', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))


    def backwards(self, orm):
        
        # Changing field 'BusinessUnit.title_slug'
        db.alter_column('seo_businessunit', 'title_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

        # Changing field 'BusinessUnit.title'
        db.alter_column('seo_businessunit', 'title', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
