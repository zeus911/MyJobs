...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'facet.show_description'
        db.add_column('seo_facet', 'show_description', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'facet.show_description'
        db.delete_column('seo_facet', 'show_description')
