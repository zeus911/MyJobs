...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SeoSiteRedirect', fields ['redirect_url']
        db.create_index('seo_seositeredirect', ['redirect_url'])


    def backwards(self, orm):
        # Removing index on 'SeoSiteRedirect', fields ['redirect_url']
        db.delete_index('seo_seositeredirect', ['redirect_url'])
