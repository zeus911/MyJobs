...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field site on 'CustomFacet'
        db.delete_table('seo_customfacet_site')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field site on 'CustomFacet'
        db.create_table('seo_customfacet_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customfacet', models.ForeignKey(orm['seo.customfacet'], null=False)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False))
        ))
        db.create_unique('seo_customfacet_site', ['customfacet_id', 'seosite_id'])
