...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuration.percent_featured'
        db.add_column('seo_configuration', 'percent_featured', self.gf('django.db.models.fields.DecimalField')(default=0.5, max_digits=3, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Configuration.percent_featured'
        db.delete_column('seo_configuration', 'percent_featured')
