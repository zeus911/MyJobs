...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SeoSiteFacet.is_default'
        db.delete_column('seo_seositefacet', 'is_default')


    def backwards(self, orm):
        
        # Adding field 'SeoSiteFacet.is_default'
        db.add_column('seo_seositefacet', 'is_default', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
