...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BillboardHotspot.title'
        db.alter_column('seo_billboardhotspot', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'BillboardHotspot.text'
        db.alter_column('seo_billboardhotspot', 'text', self.gf('django.db.models.fields.CharField')(max_length=140))


    def backwards(self, orm):
        
        # Changing field 'BillboardHotspot.title'
        db.alter_column('seo_billboardhotspot', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'BillboardHotspot.text'
        db.alter_column('seo_billboardhotspot', 'text', self.gf('django.db.models.fields.TextField')(max_length=200))
