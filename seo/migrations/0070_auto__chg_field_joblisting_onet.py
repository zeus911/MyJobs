...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'jobListing.onet'
        db.alter_column('seo_joblisting', 'onet_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['moc_coding.Onet'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'jobListing.onet'
        db.alter_column('seo_joblisting', 'onet_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Onet'], null=True))
    ...
    models = {
        ...
        'seo.businessunit': {
            ...
            'customcareers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['moc_coding.CustomCareer']", 'null': 'True', 'blank': 'True'}),
