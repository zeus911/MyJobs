...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Country.abbrev'
        db.add_column('seo_country', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)

        # Adding field 'Country.abbrev_short'
        db.add_column('seo_country', 'abbrev_short', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Country.abbrev'
        db.delete_column('seo_country', 'abbrev')

        # Deleting field 'Country.abbrev_short'
        db.delete_column('seo_country', 'abbrev_short')
    ...
    models = {
        ...
        'seo.country': {
            ...
            'abbrev_short': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'seo.facet': {
