...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.product_access'
        db.add_column(u'seo_company', 'product_access',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Company.user_created'
        db.add_column(u'seo_company', 'user_created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Company.product_access'
        db.delete_column(u'seo_company', 'product_access')

        # Deleting field 'Company.user_created'
        db.delete_column(u'seo_company', 'user_created')
