...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('seo_configuration', 'career_site_text', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Configuration.career_site_link'
        db.add_column('seo_configuration', 'career_site_link', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)
