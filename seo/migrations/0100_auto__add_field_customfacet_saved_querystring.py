...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomFacet.saved_querystring'
        db.add_column('seo_customfacet', 'saved_querystring',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomFacet.saved_querystring'
        db.delete_column('seo_customfacet', 'saved_querystring')
