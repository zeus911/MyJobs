...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomFacet.company'
        db.add_column('seo_customfacet', 'company', self.gf('django.db.models.fields.CharField')(max_length=800, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomFacet.company'
        db.delete_column('seo_customfacet', 'company')
