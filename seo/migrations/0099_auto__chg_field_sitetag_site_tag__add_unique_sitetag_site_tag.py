...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SeoSiteFacet', fields ['boolean_operation']
        db.create_index('seo_seositefacet', ['boolean_operation'])


        # Changing field 'SiteTag.site_tag'
        db.alter_column('seo_sitetag', 'site_tag', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))
        # Adding unique constraint on 'SiteTag', fields ['site_tag']
        db.create_unique('seo_sitetag', ['site_tag'])


    def backwards(self, orm):
        # Removing unique constraint on 'SiteTag', fields ['site_tag']
        db.delete_unique('seo_sitetag', ['site_tag'])

        # Removing index on 'SeoSiteFacet', fields ['boolean_operation']
        db.delete_index('seo_seositefacet', ['boolean_operation'])


        # Changing field 'SiteTag.site_tag'
        db.alter_column('seo_sitetag', 'site_tag', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'seo.seosite': {
            ...
            'site_tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['seo.SiteTag']", 'null': 'True', 'blank': 'True'}),
