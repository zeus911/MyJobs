...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seo_specialcommitment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('commit', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('seo', ['SpecialCommitment'])

        # Adding M2M table for field special_commitments on 'SeoSite'
        db.create_table('seo_seosite_special_commitments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('specialcommitment', models.ForeignKey(orm['seo.specialcommitment'], null=False))
        ))
        db.create_unique('seo_seosite_special_commitments', ['seosite_id', 'specialcommitment_id'])


    def backwards(self, orm):
        
        # Deleting model 'SpecialCommitment'
        db.delete_table('seo_specialcommitment')

        # Removing M2M table for field special_commitments on 'SeoSite'
        db.delete_table('seo_seosite_special_commitments')
