...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.show_home_microsite_carousel'
        db.add_column('seo_configuration', 'show_home_microsite_carousel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Configuration.show_home_social_footer'
        db.add_column('seo_configuration', 'show_home_social_footer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.show_home_microsite_carousel'
        db.delete_column('seo_configuration', 'show_home_microsite_carousel')

        # Deleting field 'Configuration.show_home_social_footer'
        db.delete_column('seo_configuration', 'show_home_social_footer')
