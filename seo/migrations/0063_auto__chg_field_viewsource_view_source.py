...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ViewSource.view_source'
        db.alter_column('seo_viewsource', 'view_source', self.gf('django.db.models.fields.IntegerField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'ViewSource.view_source'
        db.alter_column('seo_viewsource', 'view_source', self.gf('django.db.models.fields.CharField')(max_length=20))
