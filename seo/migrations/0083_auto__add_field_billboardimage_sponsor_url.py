...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillboardImage.sponsor_url'
        db.add_column('seo_billboardimage', 'sponsor_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillboardImage.sponsor_url'
        db.delete_column('seo_billboardimage', 'sponsor_url')
