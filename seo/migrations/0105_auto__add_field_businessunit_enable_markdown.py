...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessUnit.enable_markdown'
        db.add_column('seo_businessunit', 'enable_markdown',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessUnit.enable_markdown'
        db.delete_column('seo_businessunit', 'enable_markdown')
