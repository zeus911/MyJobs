...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seo_viewsource', (
            ...
            ('view_source', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
        ))
        db.send_create_signal('seo', ['ViewSource'])

        # Adding model 'ATSSourceCode'
        db.create_table('seo_atssourcecode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
        ...
        db.send_create_signal('seo', ['ATSSourceCode'])

        # Adding model 'GoogleAnalyticsCampaign'
        db.create_table('seo_googleanalyticscampaign', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True)),
        ...
        db.send_create_signal('seo', ['GoogleAnalyticsCampaign'])

        # Adding field 'SeoSite.google_analytics_campaigns'
        db.add_column('seo_seosite', 'google_analytics_campaigns', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.GoogleAnalyticsCampaign'], null=True, blank=True), keep_default=False)

        # Adding field 'SeoSite.view_sources'
        db.add_column('seo_seosite', 'view_sources', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.ViewSource'], null=True, blank=True), keep_default=False)

        # Adding M2M table for field ats_source_codes on 'SeoSite'
        db.create_table('seo_seosite_ats_source_codes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('atssourcecode', models.ForeignKey(orm['seo.atssourcecode'], null=False))
        ))
        db.create_unique('seo_seosite_ats_source_codes', ['seosite_id', 'atssourcecode_id'])


    def backwards(self, orm):
        
        # Deleting model 'ViewSource'
        db.delete_table('seo_viewsource')

        # Deleting model 'ATSSourceCode'
        db.delete_table('seo_atssourcecode')

        # Deleting model 'GoogleAnalyticsCampaign'
        db.delete_table('seo_googleanalyticscampaign')

        # Deleting field 'SeoSite.google_analytics_campaigns'
        db.delete_column('seo_seosite', 'google_analytics_campaigns_id')

        # Deleting field 'SeoSite.view_sources'
        db.delete_column('seo_seosite', 'view_sources_id')

        # Removing M2M table for field ats_source_codes on 'SeoSite'
        db.delete_table('seo_seosite_ats_source_codes')
    ...
    models = {
        ...
        'seo.viewsource': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'view_source': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'})
        },
        'sites.site': {
