...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomFacet.always_show'
        db.add_column('seo_customfacet', 'always_show', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Configuration.browse_company_show'
        db.add_column('seo_configuration', 'browse_company_show', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Configuration.browse_company_text'
        db.add_column('seo_configuration', 'browse_company_text', self.gf('django.db.models.fields.CharField')(default='Company', max_length=50), keep_default=False)

        # Adding field 'Configuration.browse_company_order'
        db.add_column('seo_configuration', 'browse_company_order', self.gf('django.db.models.fields.IntegerField')(default=7), keep_default=False)

        # Adding field 'Configuration.company_tag'
        db.add_column('seo_configuration', 'company_tag', self.gf('django.db.models.fields.CharField')(default='careers', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomFacet.always_show'
        db.delete_column('seo_customfacet', 'always_show')

        # Deleting field 'Configuration.browse_company_show'
        db.delete_column('seo_configuration', 'browse_company_show')

        # Deleting field 'Configuration.browse_company_text'
        db.delete_column('seo_configuration', 'browse_company_text')

        # Deleting field 'Configuration.browse_company_order'
        db.delete_column('seo_configuration', 'browse_company_order')

        # Deleting field 'Configuration.company_tag'
        db.delete_column('seo_configuration', 'company_tag')
    ...
    models = {
        ...
        'seo.customfacet': {
            ...
            'site': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['seo.SeoSite']", 'null': 'True', 'symmetrical': 'False'}),
        ...
        'seo.joblisting': {
            ...
            'onet': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['seo.Onet']", 'null': 'True', 'blank': 'True'}),
