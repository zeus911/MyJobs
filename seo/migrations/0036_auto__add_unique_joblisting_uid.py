...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'jobListing', fields ['uid']
        db.create_unique('seo_joblisting', ['uid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'jobListing', fields ['uid']
        db.delete_unique('seo_joblisting', ['uid'])
