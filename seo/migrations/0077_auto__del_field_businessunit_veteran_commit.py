...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BusinessUnit.veteran_commit'
        db.delete_column('seo_businessunit', 'veteran_commit')


    def backwards(self, orm):
        
        # Adding field 'BusinessUnit.veteran_commit'
        db.add_column('seo_businessunit', 'veteran_commit', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
