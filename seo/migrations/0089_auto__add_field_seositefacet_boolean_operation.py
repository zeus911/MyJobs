...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SeoSiteFacet.boolean_operation'
        db.add_column('seo_seositefacet', 'boolean_operation', self.gf('django.db.models.fields.CharField')(default='or', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SeoSiteFacet.boolean_operation'
        db.delete_column('seo_seositefacet', 'boolean_operation')
