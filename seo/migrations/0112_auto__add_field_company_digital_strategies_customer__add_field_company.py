...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'seo_company', 'digital_strategies_customer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Company.enhanced'
        db.add_column(u'seo_company', 'enhanced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'seo_company', 'digital_strategies_customer')

        # Deleting field 'Company.enhanced'
        db.delete_column(u'seo_company', 'enhanced')
