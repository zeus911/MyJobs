...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteTag.tag_navigation'
        db.add_column('seo_sitetag', 'tag_navigation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteTag.tag_navigation'
        db.delete_column('seo_sitetag', 'tag_navigation')
