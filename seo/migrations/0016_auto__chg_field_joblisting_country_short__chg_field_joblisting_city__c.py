...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'jobListing.country_short'
        db.alter_column(u'seo_joblisting', 'country_short', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'jobListing.city'
        db.alter_column(u'seo_joblisting', 'city', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'jobListing.country'
        db.alter_column(u'seo_joblisting', 'country', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'jobListing.zipcode'
        db.alter_column(u'seo_joblisting', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'jobListing.state'
        db.alter_column(u'seo_joblisting', 'state', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'jobListing.location'
        db.alter_column(u'seo_joblisting', 'location', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'jobListing.reqid'
        db.alter_column(u'seo_joblisting', 'reqid', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'jobListing.state_short'
        db.alter_column(u'seo_joblisting', 'state_short', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'CustomFacet.city'
        db.alter_column(u'seo_customfacet', 'city', self.gf('django.db.models.fields.CharField')(max_length=800))

        # Changing field 'CustomFacet.country'
        db.alter_column(u'seo_customfacet', 'country', self.gf('django.db.models.fields.CharField')(max_length=800))

        # Changing field 'CustomFacet.company'
        db.alter_column(u'seo_customfacet', 'company', self.gf('django.db.models.fields.CharField')(max_length=800))

        # Changing field 'CustomFacet.state'
        db.alter_column(u'seo_customfacet', 'state', self.gf('django.db.models.fields.CharField')(max_length=800))

        # Changing field 'CustomFacet.onet'
        db.alter_column(u'seo_customfacet', 'onet', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'BusinessUnit.title_slug'
        db.alter_column(u'seo_businessunit', 'title_slug', self.gf('django.db.models.fields.SlugField')(max_length=500))

        # Changing field 'BusinessUnit.title'
        db.alter_column(u'seo_businessunit', 'title', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Country.abbrev'
        db.alter_column(u'seo_country', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Country.abbrev_short'
        db.alter_column(u'seo_country', 'abbrev_short', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Configuration.defaultBlurbTitle'
        db.alter_column(u'seo_configuration', 'defaultBlurbTitle', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Configuration.header'
        db.alter_column(u'seo_configuration', 'header', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Configuration.meta'
        db.alter_column(u'seo_configuration', 'meta', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Configuration.wide_header'
        db.alter_column(u'seo_configuration', 'wide_header', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Configuration.backgroundColor'
        db.alter_column(u'seo_configuration', 'backgroundColor', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'Configuration.body'
        db.alter_column(u'seo_configuration', 'body', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Configuration.wide_footer'
        db.alter_column(u'seo_configuration', 'wide_footer', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Configuration.defaultBlurb'
        db.alter_column(u'seo_configuration', 'defaultBlurb', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Configuration.footer'
        db.alter_column(u'seo_configuration', 'footer', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'jobListing.country_short'
        db.alter_column(u'seo_joblisting', 'country_short', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'jobListing.city'
        db.alter_column(u'seo_joblisting', 'city', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'jobListing.country'
        db.alter_column(u'seo_joblisting', 'country', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'jobListing.zipcode'
        db.alter_column(u'seo_joblisting', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'jobListing.state'
        db.alter_column(u'seo_joblisting', 'state', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'jobListing.location'
        db.alter_column(u'seo_joblisting', 'location', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'jobListing.reqid'
        db.alter_column(u'seo_joblisting', 'reqid', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'jobListing.state_short'
        db.alter_column(u'seo_joblisting', 'state_short', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'CustomFacet.city'
        db.alter_column(u'seo_customfacet', 'city', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'CustomFacet.country'
        db.alter_column(u'seo_customfacet', 'country', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'CustomFacet.company'
        db.alter_column(u'seo_customfacet', 'company', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'CustomFacet.state'
        db.alter_column(u'seo_customfacet', 'state', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'CustomFacet.onet'
        db.alter_column(u'seo_customfacet', 'onet', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'BusinessUnit.title_slug'
        db.alter_column(u'seo_businessunit', 'title_slug', self.gf('django.db.models.fields.SlugField')(max_length=500, null=True))

        # Changing field 'BusinessUnit.title'
        db.alter_column(u'seo_businessunit', 'title', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Country.abbrev'
        db.alter_column(u'seo_country', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Country.abbrev_short'
        db.alter_column(u'seo_country', 'abbrev_short', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Configuration.defaultBlurbTitle'
        db.alter_column(u'seo_configuration', 'defaultBlurbTitle', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Configuration.header'
        db.alter_column(u'seo_configuration', 'header', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Configuration.meta'
        db.alter_column(u'seo_configuration', 'meta', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Configuration.wide_header'
        db.alter_column(u'seo_configuration', 'wide_header', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Configuration.backgroundColor'
        db.alter_column(u'seo_configuration', 'backgroundColor', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))

        # Changing field 'Configuration.body'
        db.alter_column(u'seo_configuration', 'body', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Configuration.wide_footer'
        db.alter_column(u'seo_configuration', 'wide_footer', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Configuration.defaultBlurb'
        db.alter_column(u'seo_configuration', 'defaultBlurb', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Configuration.footer'
        db.alter_column(u'seo_configuration', 'footer', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'seo.businessunit': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500', 'blank': 'True'}),
            'title_slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '500', 'blank': 'True'})
        },
        u'seo.city': {
        ...
        u'seo.configuration': {
            ...
            'backgroundColor': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '6', 'blank': 'True'}),
            ...
            'defaultBlurb': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'defaultBlurbTitle': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            ...
            'footer': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Group']", 'null': 'True'}),
            'header': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            ...
            'wide_footer': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'wide_header': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'})
        },
        u'seo.country': {
            'Meta': {'object_name': 'Country'},
            'abbrev': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
            'abbrev_short': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'})
        },
        u'seo.customfacet': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '800', 'blank': 'True'}),
            'company': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '800', 'blank': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '800', 'blank': 'True'}),
            ...
            'onet': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'}),
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '800', 'blank': 'True'}),
        ...
        u'seo.joblisting': {
            ...
            'country_short': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3', 'db_index': 'True', 'blank': 'True'}),
            ...
            'reqid': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            ...
            'state_short': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        u'social_links.micrositecarousel': {
            ...
            'carousel_title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
