...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BusinessUnit.unit_id'
        db.delete_column('seo_businessunit', 'unit_id')

        # Deleting field 'BusinessUnit.active'
        db.delete_column('seo_businessunit', 'active')

        # Changing field 'BusinessUnit.id'
        db.alter_column('seo_businessunit', 'id', self.gf('django.db.models.fields.IntegerField')(max_length=10, primary_key=True))


    def backwards(self, orm):
        
        # Adding field 'BusinessUnit.unit_id'
        db.add_column('seo_businessunit', 'unit_id', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=10), keep_default=False)

        # Adding field 'BusinessUnit.active'
        db.add_column('seo_businessunit', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'BusinessUnit.id'
        db.alter_column('seo_businessunit', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
