...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuration.home_page_template'
        db.add_column('seo_configuration', 'home_page_template', self.gf('django.db.models.fields.CharField')(default='home_page/home_page_listing.html', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Configuration.home_page_template'
        db.delete_column('seo_configuration', 'home_page_template')
