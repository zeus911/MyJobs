...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field sites on 'BusinessUnit'
        db.delete_table('seo_businessunit_sites')

        # Removing M2M table for field sites on 'facet'
        db.delete_table('seo_facet_sites')

        # Removing M2M table for field group on 'SeoSite'
        db.delete_table('seo_seosite_group')

        # Adding M2M table for field groups on 'SeoSite'
        db.create_table('seo_seosite_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('seo_seosite_groups', ['seosite_id', 'group_id'])

        # Adding M2M table for field facets on 'SeoSite'
        db.create_table('seo_seosite_facets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('facet', models.ForeignKey(orm['seo.facet'], null=False))
        ))
        db.create_unique('seo_seosite_facets', ['seosite_id', 'facet_id'])

        # Adding M2M table for field configurations on 'SeoSite'
        db.create_table('seo_seosite_configurations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('configuration', models.ForeignKey(orm['seo.configuration'], null=False))
        ))
        db.create_unique('seo_seosite_configurations', ['seosite_id', 'configuration_id'])

        # Adding M2M table for field google_analytics on 'SeoSite'
        db.create_table('seo_seosite_google_analytics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('googleanalytics', models.ForeignKey(orm['seo.googleanalytics'], null=False))
        ))
        db.create_unique('seo_seosite_google_analytics', ['seosite_id', 'googleanalytics_id'])
        ...
        # Removing M2M table for field sites on 'GoogleAnalytics'
        db.delete_table('seo_googleanalytics_sites')

        # Removing M2M table for field sites on 'Configuration'
        db.delete_table('seo_configuration_sites')


    def backwards(self, orm):
        
        # Adding M2M table for field sites on 'BusinessUnit'
        db.create_table('seo_businessunit_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('businessunit', models.ForeignKey(orm['seo.businessunit'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('seo_businessunit_sites', ['businessunit_id', 'site_id'])
        ...
        # Adding M2M table for field group on 'SeoSite'
        db.create_table('seo_seosite_group', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('seo_seosite_group', ['seosite_id', 'group_id'])

        # Removing M2M table for field groups on 'SeoSite'
        db.delete_table('seo_seosite_groups')

        # Removing M2M table for field facets on 'SeoSite'
        db.delete_table('seo_seosite_facets')

        # Removing M2M table for field configurations on 'SeoSite'
        db.delete_table('seo_seosite_configurations')

        # Removing M2M table for field google_analytics on 'SeoSite'
        db.delete_table('seo_seosite_google_analytics')

        # Removing M2M table for field business_units on 'SeoSite'
        db.delete_table('seo_seosite_business_units')

        # Adding M2M table for field sites on 'GoogleAnalytics'
        db.create_table('seo_googleanalytics_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('googleanalytics', models.ForeignKey(orm['seo.googleanalytics'], null=False)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False))
        ))
        db.create_unique('seo_googleanalytics_sites', ['googleanalytics_id', 'seosite_id'])

        # Adding M2M table for field sites on 'Configuration'
        db.create_table('seo_configuration_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('configuration', models.ForeignKey(orm['seo.configuration'], null=False)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False))
        ))
        db.create_unique('seo_configuration_sites', ['configuration_id', 'seosite_id'])
    ...
    models = {
        ...
        'seo.seosite': {
            ...
            'business_units': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['seo.BusinessUnit']", 'symmetrical': 'False'}),
