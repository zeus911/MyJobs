...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuration.directemployers_link'
        db.add_column('seo_configuration', 'directemployers_link', self.gf('django.db.models.fields.CharField')(default='http://directemployers.org', max_length=200), keep_default=False)

        # Adding field 'Configuration.career_site_link'
        db.add_column('seo_configuration', 'career_site_link', self.gf('django.db.models.fields.CharField')(default='#', max_length=200), keep_default=False)

        # Adding field 'Configuration.career_site_text'
        db.add_column('seo_configuration', 'career_site_text', self.gf('django.db.models.fields.CharField')(default='career site', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Configuration.directemployers_link'
        db.delete_column('seo_configuration', 'directemployers_link')

        # Deleting field 'Configuration.career_site_link'
        db.delete_column('seo_configuration', 'career_site_link')

        # Deleting field 'Configuration.career_site_text'
        db.delete_column('seo_configuration', 'career_site_text')
    ...
    models = {
        ...
        'seo.configuration': {
            ...
            'career_site_link': ('django.db.models.fields.CharField', [], {'default': "'#'", 'max_length': '200'}),
            'career_site_text': ('django.db.models.fields.CharField', [], {'default': "'career site'", 'max_length': '200'}),
            ...
            'default_blurb_always_show': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'directemployers_link': ('django.db.models.fields.CharField', [], {'default': "'http://directemployers.org'", 'max_length': '200'}),
