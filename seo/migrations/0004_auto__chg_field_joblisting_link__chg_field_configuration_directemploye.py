...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'jobListing.link'
        db.alter_column('seo_joblisting', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Configuration.directemployers_link'
        db.alter_column('seo_configuration', 'directemployers_link', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Configuration.career_site_link'
        db.alter_column('seo_configuration', 'career_site_link', self.gf('django.db.models.fields.URLField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'jobListing.link'
        db.alter_column('seo_joblisting', 'link', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Configuration.directemployers_link'
        db.alter_column('seo_configuration', 'directemployers_link', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Configuration.career_site_link'
        db.alter_column('seo_configuration', 'career_site_link', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'seo.configuration': {
            ...
            'career_site_link': ('django.db.models.fields.URLField', [], {'default': "'#'", 'max_length': '200'}),
