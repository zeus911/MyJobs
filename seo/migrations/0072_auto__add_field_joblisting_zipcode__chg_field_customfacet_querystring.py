...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'jobListing.zipcode'
        db.add_column('seo_joblisting', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'jobListing.zipcode'
        db.delete_column('seo_joblisting', 'zipcode')
