...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seo_customfacet_business_units', (
        ...
        db.create_unique('seo_customfacet_business_units', ['customfacet_id', 'businessunit_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field business_units on 'CustomFacet'
        db.delete_table('seo_customfacet_business_units')
