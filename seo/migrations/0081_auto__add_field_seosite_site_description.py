...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SeoSite.site_description'
        db.add_column('seo_seosite', 'site_description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SeoSite.site_description'
        db.delete_column('seo_seosite', 'site_description')
