...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Configuration.is_production'
        db.delete_column('seo_configuration', 'is_production')

        # Deleting field 'Configuration.is_staging'
        db.delete_column('seo_configuration', 'is_staging')

        # Adding field 'Configuration.status'
        db.add_column('seo_configuration', 'status', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Configuration.is_production'
        db.add_column('seo_configuration', 'is_production', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Configuration.is_staging'
        db.add_column('seo_configuration', 'is_staging', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Configuration.status'
        db.delete_column('seo_configuration', 'status')
