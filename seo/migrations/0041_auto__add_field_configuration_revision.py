...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuration.revision'
        db.add_column('seo_configuration', 'revision', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Configuration.revision'
        db.delete_column('seo_configuration', 'revision')
