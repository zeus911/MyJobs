...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomFacet.onet'
        db.add_column('seo_customfacet', 'onet', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomFacet.onet'
        db.delete_column('seo_customfacet', 'onet')
