...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Moc.moc_detail'
        db.add_column('seo_moc', 'moc_detail', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['seo.MocDetail'], unique=True, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Moc.moc_detail'
        db.delete_column('seo_moc', 'moc_detail_id')
