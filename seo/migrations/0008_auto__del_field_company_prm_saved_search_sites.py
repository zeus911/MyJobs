...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field prm_saved_search_sites on 'Company'
        m2m_table_name = db.shorten_name(u'seo_company_prm_saved_search_sites')
        ...
        db.create_unique(m2m_table_name, ['company_id', 'seosite_id'])

    def backwards(self, orm):
        # Removing M2M table for field prm_saved_search_sites on 'Company'
        db.delete_table(db.shorten_name(u'seo_company_prm_saved_search_sites'))
