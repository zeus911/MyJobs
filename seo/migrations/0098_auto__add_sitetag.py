...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seo_sitetag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site_tag', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('seo', ['SiteTag'])

        # Adding M2M table for field site_tags on 'SeoSite'
        db.create_table('seo_seosite_site_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('sitetag', models.ForeignKey(orm['seo.sitetag'], null=False))
        ))
        db.create_unique('seo_seosite_site_tags', ['seosite_id', 'sitetag_id'])


    def backwards(self, orm):
        # Deleting model 'SiteTag'
        db.delete_table('seo_sitetag')

        # Removing M2M table for field site_tags on 'SeoSite'
        db.delete_table('seo_seosite_site_tags')
    ...
    models = {
        ...
        'seo.sitetag': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site_tag': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
