...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('seo_country', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Country.abbrev_short'
        db.alter_column('seo_country', 'abbrev_short', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Country.abbrev'
        db.alter_column('seo_country', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Country.abbrev_short'
        db.alter_column('seo_country', 'abbrev_short', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
