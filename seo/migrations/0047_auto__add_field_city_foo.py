...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'City.foo'
        db.add_column('seo_city', 'foo', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'City.foo'
        db.delete_column('seo_city', 'foo')
    ...
    models = {
        ...
        'seo.city': {
            ...
            'foo': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
