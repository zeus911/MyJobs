...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('myjobs_shared_sessions', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.User'], unique=True)),
        ))
        db.send_create_signal(u'seo', ['Shared_Sessions'])


    def backwards(self, orm):
        # Deleting model 'Shared_Sessions'
        db.delete_table('myjobs_shared_sessions')
