...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'facet.jobCount'
        db.delete_column('seo_facet', 'jobCount')


    def backwards(self, orm):
        
        # Adding field 'facet.jobCount'
        db.add_column('seo_facet', 'jobCount', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
