...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuration.show_social_footer'
        db.add_column('seo_configuration', 'show_social_footer', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Configuration.show_social_footer'
        db.delete_column('seo_configuration', 'show_social_footer')
