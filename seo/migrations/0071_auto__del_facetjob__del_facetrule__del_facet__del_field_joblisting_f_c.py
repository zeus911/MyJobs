...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'jobListing.f_city'
        db.delete_column('seo_joblisting', 'f_city')

        # Deleting field 'jobListing.f_state'
        db.delete_column('seo_joblisting', 'f_state')

        # Deleting field 'jobListing.f_title'
        db.delete_column('seo_joblisting', 'f_title')

        # Deleting field 'jobListing.f_country'
        db.delete_column('seo_joblisting', 'f_country')

        # Adding unique constraint on 'SeoSiteRedirect', fields ['seosite', 'redirect_url']
        db.create_unique('seo_seositeredirect', ['seosite_id', 'redirect_url'])

        # Deleting field 'BusinessUnit.scheduled'
        db.delete_column('seo_businessunit', 'scheduled')

        # Removing M2M table for field customcareers on 'BusinessUnit'
        db.delete_table('seo_businessunit_customcareers')


    def backwards(self, orm):
        
        # Removing unique constraint on 'SeoSiteRedirect', fields ['seosite', 'redirect_url']
        db.delete_unique('seo_seositeredirect', ['seosite_id', 'redirect_url'])
        ...
        db.create_table('seo_facet', (
            ...
            ('default_country', self.gf('django.db.models.fields.CharField')(default='USA', max_length=3)),
            ...
            ('facetSlug', self.gf('django.db.models.fields.SlugField')(blank=True, max_length=200, null=True, db_index=True)),
        ...
        # Adding field 'jobListing.f_city'
        db.add_column('seo_joblisting', 'f_city', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'jobListing.f_state'
        db.add_column('seo_joblisting', 'f_state', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'jobListing.f_title'
        db.add_column('seo_joblisting', 'f_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'jobListing.f_country'
        db.add_column('seo_joblisting', 'f_country', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'BusinessUnit.scheduled'
        db.add_column('seo_businessunit', 'scheduled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding M2M table for field customcareers on 'BusinessUnit'
        db.create_table('seo_businessunit_customcareers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('businessunit', models.ForeignKey(orm['seo.businessunit'], null=False)),
            ('customcareer', models.ForeignKey(orm['moc_coding.customcareer'], null=False))
        ))
        db.create_unique('seo_businessunit_customcareers', ['businessunit_id', 'customcareer_id'])
    ...
    models = {
        ...
        'seo.businessunit': {
            ...
            'veteran_commit': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'seo.city': {
        ...
        'seo.customfacet': {
            ...
            'querystring': ('django.db.models.fields.CharField', [], {'max_length': '10000', 'null': 'True', 'blank': 'True'}),
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['seo.SeoSite']", 'null': 'True', 'symmetrical': 'False'}),
        ...
        'seo.seosite': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Group']", 'null': 'True'}),
            'microsite_carousel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['social_links.MicrositeCarousel']", 'null': 'True', 'blank': 'True'}),
