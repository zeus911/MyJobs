...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'facet.show_production'
        db.add_column('seo_facet', 'show_production', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'facet.show_production'
        db.delete_column('seo_facet', 'show_production')
