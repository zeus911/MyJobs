...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'facet.default_country'
        db.add_column('seo_facet', 'default_country', self.gf('django.db.models.fields.CharField')(default='USA', max_length=3), keep_default=False)

        # Deleting field 'facetJob.facetRule'
        db.delete_column('seo_facetjob', 'facetRule_id')


    def backwards(self, orm):
        
        # Deleting field 'facet.default_country'
        db.delete_column('seo_facet', 'default_country')

        # Adding field 'facetJob.facetRule'
        db.add_column('seo_facetjob', 'facetRule', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['seo.facetRule']), keep_default=False)
