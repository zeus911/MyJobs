...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seo_seosite', (
            ...
            ('default_facet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.facet'], null=True, blank=True)),
        ))
        db.send_create_signal('seo', ['SeoSite'])


    def backwards(self, orm):
        
        # Deleting model 'SeoSite'
        db.delete_table('seo_seosite')
