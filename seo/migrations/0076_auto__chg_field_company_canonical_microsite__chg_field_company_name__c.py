...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.canonical_microsite'
        db.alter_column('seo_company', 'canonical_microsite', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Company.name'
        db.alter_column('seo_company', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.company_slug'
        db.alter_column('seo_company', 'company_slug', self.gf('django.db.models.fields.SlugField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'Company.canonical_microsite'
        db.alter_column('seo_company', 'canonical_microsite', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

        # Changing field 'Company.name'
        db.alter_column('seo_company', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Company.company_slug'
        db.alter_column('seo_company', 'company_slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))
    ...
    models = {
        ...
        'seo.businessunit': {
            ...
            'title_slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '500', 'null': 'True', 'blank': 'True'}),
        ...
        'seo.company': {
            ...
            'company_slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'social_links.sociallink': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Group']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link_icon': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '30'}),
            'link_title': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'link_type': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
