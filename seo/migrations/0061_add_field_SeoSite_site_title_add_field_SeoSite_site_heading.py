...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SeoSite.site_title'
        db.add_column('seo_seosite', 'site_title', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'SeoSite.site_heading'
        db.add_column('seo_seosite', 'site_heading', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SeoSite.site_title'
        db.delete_column('seo_seosite', 'site_title')

        # Deleting field 'SeoSite.site_heading'
        db.delete_column('seo_seosite', 'site_heading')
