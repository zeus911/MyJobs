...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessUnit.ignore_includeinindex'
        db.add_column(u'seo_businessunit', 'ignore_includeinindex',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessUnit.ignore_includeinindex'
        db.delete_column(u'seo_businessunit', 'ignore_includeinindex')
