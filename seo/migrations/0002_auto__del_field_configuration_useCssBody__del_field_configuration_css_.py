...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'seo_configuration', 'useCssBody')

        # Deleting field 'Configuration.css_body'
        db.delete_column(u'seo_configuration', 'css_body')

        # Deleting field 'Configuration.secondaryColor'
        db.delete_column(u'seo_configuration', 'secondaryColor')


    def backwards(self, orm):
        # Adding field 'Configuration.useCssBody'
        db.add_column(u'seo_configuration', 'useCssBody',
                      self.gf('django.db.models.fields.BooleanField')(default=''),
                      keep_default=False)

        # Adding field 'Configuration.css_body'
        db.add_column(u'seo_configuration', 'css_body',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Configuration.secondaryColor'
        db.add_column(u'seo_configuration', 'secondaryColor',
