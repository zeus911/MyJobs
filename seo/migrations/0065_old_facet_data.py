...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Create a table to back up the SeoSite facet information."""
        db.create_table('seo_seosite_facet_backup', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True,
                                    auto_created=True)),
            ('seosite', models.ForeignKey(orm['seo.seosite'], null=False)),
            ('facet', models.ForeignKey(orm['seo.facet'], null=False))
        ))
        db.create_unique('seo_seosite_facet_backup', ['seosite_id', 'facet_id'])
        db.execute('INSERT seo_seosite_facet_backup SELECT * FROM seo_seosite_facets')

    def backwards(self, orm):
        db.delete_table('seo_seosite_facet_backup')
