...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'City.foo'
        raise RuntimeError("Cannot reverse this migration. 'City.foo' and its values cannot be restored.")
