...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Moc.branch'
        db.alter_column('seo_moc', 'branch', self.gf('django.db.models.fields.CharField')(max_length=11))


    def backwards(self, orm):
        
        # Changing field 'Moc.branch'
        db.alter_column('seo_moc', 'branch', self.gf('django.db.models.fields.CharField')(max_length=1))
