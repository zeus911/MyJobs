...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.publisher'
        db.add_column('seo_configuration', 'publisher',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.publisher'
        db.delete_column('seo_configuration', 'publisher')
