...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ticket'
        db.create_table('myjobs_ticket', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.User'])),
        ))
        db.send_create_signal(u'seo', ['Ticket'])

        # Adding unique constraint on 'Ticket', fields ['ticket', 'user']
        db.create_unique('myjobs_ticket', ['ticket', 'user_id'])

        # Adding model 'Related_Sessions'
        db.create_table('myjobs_related_sessions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.User'])),
        ))
        db.send_create_signal(u'seo', ['Related_Sessions'])

        # Adding M2M table for field mj_session on 'Related_Sessions'
        db.create_table('myjobs_related_sessions_mj_session', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('related_sessions', models.ForeignKey(orm[u'seo.related_sessions'], null=False)),
            ('session', models.ForeignKey(orm[u'sessions.session'], null=False))
        ))
        db.create_unique('myjobs_related_sessions_mj_session', ['related_sessions_id', 'session_id'])

        # Adding M2M table for field ms_session on 'Related_Sessions'
        db.create_table('myjobs_related_sessions_ms_session', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('related_sessions', models.ForeignKey(orm[u'seo.related_sessions'], null=False)),
            ('session', models.ForeignKey(orm[u'sessions.session'], null=False))
        ))
        db.create_unique('myjobs_related_sessions_ms_session', ['related_sessions_id', 'session_id'])
        ...
        db.create_table('myjobs_user', (
            ...
            ('gravatar', self.gf('django.db.models.fields.EmailField')(db_index=True, max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal(u'seo', ['User'])

        # Adding M2M table for field groups on 'User'
        db.create_table('myjobs_user_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'seo.user'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique('myjobs_user_groups', ['user_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'User'
        db.create_table('myjobs_user_user_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'seo.user'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique('myjobs_user_user_permissions', ['user_id', 'permission_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ticket', fields ['ticket', 'user']
        db.delete_unique('myjobs_ticket', ['ticket', 'user_id'])

        # Deleting model 'Ticket'
        db.delete_table('myjobs_ticket')

        # Deleting model 'Related_Sessions'
        db.delete_table('myjobs_related_sessions')
    ...
    models = {
        ...
        u'seo.related_sessions': {
            'Meta': {'object_name': 'Related_Sessions', 'db_table': "'myjobs_related_sessions'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
