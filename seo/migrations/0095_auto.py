...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SeoSiteFacet', fields ['facet_type']
        db.create_index('seo_seositefacet', ['facet_type'])


    def backwards(self, orm):
        # Removing index on 'SeoSiteFacet', fields ['facet_type']
        db.delete_index('seo_seositefacet', ['facet_type'])
