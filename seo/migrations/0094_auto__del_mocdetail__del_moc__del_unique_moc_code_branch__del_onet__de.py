...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('seo_mocdetail')

        # Deleting model 'Moc'
        db.delete_table('seo_moc')

        # Removing M2M table for field jobs on 'Moc'
        db.delete_table('seo_moc_jobs')
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal('seo', ['MocDetail'])

        # Adding model 'Moc'
        db.create_table('seo_moc', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=20, db_index=True)),
            ('moc_detail', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['seo.MocDetail'], unique=True, null=True)),
        ...
        # Adding M2M table for field jobs on 'Moc'
        db.create_table('seo_moc_jobs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('moc', models.ForeignKey(orm['seo.moc'], null=False)),
            ('joblisting', models.ForeignKey(orm['seo.joblisting'], null=False))
        ))
        db.create_unique('seo_moc_jobs', ['moc_id', 'joblisting_id'])
