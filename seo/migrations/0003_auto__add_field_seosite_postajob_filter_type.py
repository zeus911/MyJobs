...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SeoSite.postajob_filter_type'
        db.add_column(u'seo_seosite', 'postajob_filter_type',
                      self.gf('django.db.models.fields.CharField')(default='this site only', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SeoSite.postajob_filter_type'
        db.delete_column(u'seo_seosite', 'postajob_filter_type')
