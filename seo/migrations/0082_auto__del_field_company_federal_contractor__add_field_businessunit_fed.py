...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Company.federal_contractor'
        db.delete_column('seo_company', 'federal_contractor')

        # Adding field 'BusinessUnit.federal_contractor'
        db.add_column('seo_businessunit', 'federal_contractor', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Company.federal_contractor'
        db.add_column('seo_company', 'federal_contractor', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'BusinessUnit.federal_contractor'
        db.delete_column('seo_businessunit', 'federal_contractor')
