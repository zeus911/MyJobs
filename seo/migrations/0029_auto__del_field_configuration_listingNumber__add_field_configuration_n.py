...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'Configuration.listingNumber'
        db.rename_column('seo_configuration', 'listingNumber', 'num_job_items_to_show')


    def backwards(self, orm):

        # Rename field 'Configuration.num_job_items_to_show'
        db.rename_column('seo_configuration', 'num_job_items_to_show', 'listingNumber')
