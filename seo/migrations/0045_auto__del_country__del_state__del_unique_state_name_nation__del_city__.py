...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('seo_city', ['name', 'state_id'])

        # Removing unique constraint on 'State', fields ['name', 'nation']
        db.delete_unique('seo_state', ['name', 'nation_id'])

        # Deleting model 'Country'
        db.delete_table('seo_country')

        # Deleting model 'State'
        db.delete_table('seo_state')

        # Deleting model 'City'
        db.delete_table('seo_city')


    def backwards(self, orm):
        
        # Adding model 'Country'
        db.create_table('seo_country', (
            ('abbrev', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('abbrev_short', self.gf('django.db.models.fields.CharField')(blank=True, max_length=255, null=True, db_index=True)),
        ))
        db.send_create_signal('seo', ['Country'])

        # Adding model 'State'
        db.create_table('seo_state', (
            ('nation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Country'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
        ))
        db.send_create_signal('seo', ['State'])

        # Adding unique constraint on 'State', fields ['name', 'nation']
        db.create_unique('seo_state', ['name', 'nation_id'])

        # Adding model 'City'
        db.create_table('seo_city', (
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.State'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
        ))
        db.send_create_signal('seo', ['City'])

        # Adding unique constraint on 'City', fields ['name', 'state']
        db.create_unique('seo_city', ['name', 'state_id'])
