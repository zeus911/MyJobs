...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SeoSite.canonical_company'
        db.add_column(u'seo_seosite', 'canonical_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='canonical_company', null=True, on_delete=models.SET_NULL, to=orm['seo.Company']),
                      keep_default=False)

        # Adding field 'SeoSite.email_domain'
        db.add_column(u'seo_seosite', 'email_domain',
                      self.gf('django.db.models.fields.CharField')(default='my.jobs', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SeoSite.canonical_company'
        db.delete_column(u'seo_seosite', 'canonical_company_id')

        # Deleting field 'SeoSite.email_domain'
        db.delete_column(u'seo_seosite', 'email_domain')
    ...
    models = {
        ...
        u'seo.seosite': {
            ...
            'business_units': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['seo.BusinessUnit']", 'null': 'True', 'blank': 'True'}),
            'canonical_company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'canonical_company'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['seo.Company']"}),
