...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seo_featuredcompany', (
        ...
        db.send_create_signal('seo', ['FeaturedCompany'])

        # Adding model 'Company'
        db.create_table('seo_company', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('company_slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=255, null=True, blank=True)),
            ('logo_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('canonical_microsite', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('seo_featuredcompany')

        # Deleting model 'Company'
        db.delete_table('seo_company')

        # Removing M2M table for field job_source_ids on 'Company'
        db.delete_table('seo_company_job_source_ids')
    ...
    models = {
        ...
        'seo.company': {
            ...
            'canonical_microsite': ('django.db.models.fields.URLField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'company_slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
