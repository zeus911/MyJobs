...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'seo_company', ['name'])

        # Adding unique constraint on 'Company', fields ['name', 'user_created']
        db.create_unique(u'seo_company', ['name', 'user_created'])


    def backwards(self, orm):
        # Removing unique constraint on 'Company', fields ['name', 'user_created']
        db.delete_unique(u'seo_company', ['name', 'user_created'])

        # Adding unique constraint on 'Company', fields ['name']
        db.create_unique(u'seo_company', ['name'])
