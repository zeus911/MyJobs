...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SeoSite.microsite_carousel'
        db.add_column('seo_seosite', 'microsite_carousel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social_links.MicrositeCarousel'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SeoSite.microsite_carousel'
        db.delete_column('seo_seosite', 'microsite_carousel_id')
    ...
    models = {
        ...
        'social_links.micrositecarousel': {
            ...
            'link_sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'linked_carousel'", 'symmetrical': 'False', 'to': "orm['seo.SeoSite']"})
        }
    }
