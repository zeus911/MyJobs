...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SeoSiteFacet.facet_group'
        db.add_column(u'seo_seositefacet', 'facet_group',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_show_2'
        db.add_column(u'seo_configuration', 'browse_facet_show_2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_show_3'
        db.add_column(u'seo_configuration', 'browse_facet_show_3',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_text_2'
        db.add_column(u'seo_configuration', 'browse_facet_text_2',
                      self.gf('django.db.models.fields.CharField')(default='Job Profiles', max_length=50),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_text_3'
        db.add_column(u'seo_configuration', 'browse_facet_text_3',
                      self.gf('django.db.models.fields.CharField')(default='Job Profiles', max_length=50),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_order_2'
        db.add_column(u'seo_configuration', 'browse_facet_order_2',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_order_3'
        db.add_column(u'seo_configuration', 'browse_facet_order_3',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SeoSiteFacet.facet_group'
        db.delete_column(u'seo_seositefacet', 'facet_group')

        # Deleting field 'Configuration.browse_facet_show_2'
        db.delete_column(u'seo_configuration', 'browse_facet_show_2')

        # Deleting field 'Configuration.browse_facet_show_3'
        db.delete_column(u'seo_configuration', 'browse_facet_show_3')

        # Deleting field 'Configuration.browse_facet_text_2'
        db.delete_column(u'seo_configuration', 'browse_facet_text_2')

        # Deleting field 'Configuration.browse_facet_text_3'
        db.delete_column(u'seo_configuration', 'browse_facet_text_3')

        # Deleting field 'Configuration.browse_facet_order_2'
        db.delete_column(u'seo_configuration', 'browse_facet_order_2')

        # Deleting field 'Configuration.browse_facet_order_3'
        db.delete_column(u'seo_configuration', 'browse_facet_order_3')
