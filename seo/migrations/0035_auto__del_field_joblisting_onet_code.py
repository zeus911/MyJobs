...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'jobListing.onet_code'
        db.delete_column('seo_joblisting', 'onet_code')


    def backwards(self, orm):
        
        # Adding field 'jobListing.onet_code'
        db.add_column('seo_joblisting', 'onet_code', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True), keep_default=False)
