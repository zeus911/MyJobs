...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Country', fields ['abbrev']
        db.create_index('seo_country', ['abbrev'])

        # Adding index on 'jobListing', fields ['country_short']
        db.create_index('seo_joblisting', ['country_short'])

        # Adding index on 'Configuration', fields ['status']
        db.create_index('seo_configuration', ['status'])


    def backwards(self, orm):
        
        # Removing index on 'Configuration', fields ['status']
        db.delete_index('seo_configuration', ['status'])

        # Removing index on 'jobListing', fields ['country_short']
        db.delete_index('seo_joblisting', ['country_short'])

        # Removing index on 'Country', fields ['abbrev']
        db.delete_index('seo_country', ['abbrev'])
