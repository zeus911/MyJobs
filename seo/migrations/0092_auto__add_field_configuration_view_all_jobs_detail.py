...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.view_all_jobs_detail'
        db.add_column('seo_configuration', 'view_all_jobs_detail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.view_all_jobs_detail'
        db.delete_column('seo_configuration', 'view_all_jobs_detail')
