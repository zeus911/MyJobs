...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'jobListing.buid'
        db.delete_column('seo_joblisting', 'buid_id')
    ...
    def backwards(self, orm):
        # Adding field 'jobListing.buid'
        db.add_column('seo_joblisting', 'buid',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['seo.BusinessUnit']),
                      keep_default=False)

        # Adding field 'jobListing.onet'
        db.add_column('seo_joblisting', 'onet',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['moc_coding.Onet'], null=True, blank=True),
                      keep_default=False)
