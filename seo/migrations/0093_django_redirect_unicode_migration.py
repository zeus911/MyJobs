...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute('ALTER TABLE django_redirect CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;')
        db.execute('ALTER TABLE django_flatpage CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;')

    def backwards(self, orm):
        db.execute('ALTER TABLE django_redirect CONVERT TO CHARACTER SET latin1 COLLATE latin1_swedish_ci;')
        db.execute('ALTER TABLE django_flatpage CONVERT TO CHARACTER SET latin1 COLLATE latin1_swedish_ci;')
