...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BusinessUnit.title'
        db.add_column('seo_businessunit', 'title', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'facet.group'
        db.add_column('seo_facet', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True), keep_default=False)

        # Adding field 'SeoSite.group'
        db.add_column('seo_seosite', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field groups on 'SeoSite'
        db.delete_table('seo_seosite_groups')

        # Adding field 'GoogleAnalytics.group'
        db.add_column('seo_googleanalytics', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True), keep_default=False)

        # Adding field 'Configuration.title'
        db.add_column('seo_configuration', 'title', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'Configuration.group'
        db.add_column('seo_configuration', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BusinessUnit.title'
        db.delete_column('seo_businessunit', 'title')

        # Deleting field 'facet.group'
        db.delete_column('seo_facet', 'group_id')

        # Deleting field 'SeoSite.group'
        db.delete_column('seo_seosite', 'group_id')
        ...
        # Deleting field 'GoogleAnalytics.group'
        db.delete_column('seo_googleanalytics', 'group_id')

        # Deleting field 'Configuration.title'
        db.delete_column('seo_configuration', 'title')

        # Deleting field 'Configuration.group'
        db.delete_column('seo_configuration', 'group_id')
