...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BusinessUnit.title_slug'
        db.add_column('seo_businessunit', 'title_slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BusinessUnit.title_slug'
        db.delete_column('seo_businessunit', 'title_slug')
