...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Moc'
        db.create_table('seo_moc', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=20, db_index=True)),
            ('branch', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('title_slug', self.gf('django.db.models.fields.SlugField')(max_length=300, db_index=True)),
        ))
        db.send_create_signal('seo', ['Moc'])

        # Adding M2M table for field onets on 'Moc'
        db.create_table('seo_moc_onets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('moc', models.ForeignKey(orm['seo.moc'], null=False)),
            ('onet', models.ForeignKey(orm['seo.onet'], null=False))
        ))
        db.create_unique('seo_moc_onets', ['moc_id', 'onet_id'])

        # Adding unique constraint on 'Moc', fields ['code', 'branch']
        db.create_unique('seo_moc', ['code', 'branch'])

        # Adding model 'Onet'
        db.create_table('seo_onet', (
            ('title', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=10, primary_key=True)),
        ))
        db.send_create_signal('seo', ['Onet'])

        # Adding unique constraint on 'Onet', fields ['title', 'code']
        db.create_unique('seo_onet', ['title', 'code'])

        # Adding index on 'jobListing', fields ['onet_code']
        db.create_index('seo_joblisting', ['onet_code'])

        # Adding field 'Configuration.browse_moc_show'
        db.add_column('seo_configuration', 'browse_moc_show', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Configuration.browse_moc_text'
        db.add_column('seo_configuration', 'browse_moc_text', self.gf('django.db.models.fields.CharField')(default='Military Titles', max_length=50), keep_default=False)

        # Adding field 'Configuration.browse_moc_order'
        db.add_column('seo_configuration', 'browse_moc_order', self.gf('django.db.models.fields.IntegerField')(default=6), keep_default=False)

        # Adding field 'Configuration.moc_tag'
        db.add_column('seo_configuration', 'moc_tag', self.gf('django.db.models.fields.CharField')(default='vet-jobs', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Removing index on 'jobListing', fields ['onet_code']
        db.delete_index('seo_joblisting', ['onet_code'])

        # Removing unique constraint on 'Onet', fields ['title', 'code']
        db.delete_unique('seo_onet', ['title', 'code'])

        # Removing unique constraint on 'Moc', fields ['code', 'branch']
        db.delete_unique('seo_moc', ['code', 'branch'])

        # Deleting model 'Moc'
        db.delete_table('seo_moc')

        # Removing M2M table for field onets on 'Moc'
        db.delete_table('seo_moc_onets')

        # Deleting model 'Onet'
        db.delete_table('seo_onet')

        # Deleting field 'Configuration.browse_moc_show'
        db.delete_column('seo_configuration', 'browse_moc_show')

        # Deleting field 'Configuration.browse_moc_text'
        db.delete_column('seo_configuration', 'browse_moc_text')

        # Deleting field 'Configuration.browse_moc_order'
        db.delete_column('seo_configuration', 'browse_moc_order')

        # Deleting field 'Configuration.moc_tag'
        db.delete_column('seo_configuration', 'moc_tag')
    ...
    models = {
        ...
        'seo.configuration': {
            ...
            'browse_moc_order': ('django.db.models.fields.IntegerField', [], {'default': '6'}),
        ...
        'seo.joblisting': {
            ...
            'onet_code': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'seo.moc': {
            ...
            'branch': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
