...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Configuration.career_site_text'
        db.alter_column('seo_configuration', 'career_site_text', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Configuration.career_site_link'
        db.alter_column('seo_configuration', 'career_site_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'Configuration.career_site_text'
        db.alter_column('seo_configuration', 'career_site_text', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'seo.configuration': {
            ...
            'career_site_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'career_site_text': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
