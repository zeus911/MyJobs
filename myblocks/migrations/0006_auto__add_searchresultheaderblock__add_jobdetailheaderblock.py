...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SearchResultHeaderBlock'
        db.create_table(u'myblocks_searchresultheaderblock', (
            (u'block_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['myblocks.Block'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'myblocks', ['SearchResultHeaderBlock'])

        # Adding model 'JobDetailHeaderBlock'
        db.create_table(u'myblocks_jobdetailheaderblock', (
            (u'block_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['myblocks.Block'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'myblocks', ['JobDetailHeaderBlock'])


    def backwards(self, orm):
        # Deleting model 'SearchResultHeaderBlock'
        db.delete_table(u'myblocks_searchresultheaderblock')

        # Deleting model 'JobDetailHeaderBlock'
        db.delete_table(u'myblocks_jobdetailheaderblock')
