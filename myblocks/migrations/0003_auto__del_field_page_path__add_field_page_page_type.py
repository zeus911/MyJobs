...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'myblocks_page', 'path')

        # Adding field 'Page.page_type'
        db.add_column(u'myblocks_page', 'page_type',
                      self.gf('django.db.models.fields.CharField')(default='Login', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Page.path'
        db.add_column(u'myblocks_page', 'path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'Page.page_type'
        db.delete_column(u'myblocks_page', 'page_type')
