...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacetBlurbBlock'
        db.create_table(u'myblocks_facetblurbblock', (
            (u'block_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['myblocks.Block'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'myblocks', ['FacetBlurbBlock'])


    def backwards(self, orm):
        # Deleting model 'FacetBlurbBlock'
        db.delete_table(u'myblocks_facetblurbblock')
