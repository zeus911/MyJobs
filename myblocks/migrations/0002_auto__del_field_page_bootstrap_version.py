...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Page.bootstrap_version'
        db.delete_column(u'myblocks_page', 'bootstrap_version')


    def backwards(self, orm):
        # Adding field 'Page.bootstrap_version'
        db.add_column(u'myblocks_page', 'bootstrap_version',
