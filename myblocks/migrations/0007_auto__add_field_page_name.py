...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'myblocks_page', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding M2M table for field sites on 'Page'
        m2m_table_name = db.shorten_name(u'myblocks_page_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('page', models.ForeignKey(orm[u'myblocks.page'], null=False)),
            ('seosite', models.ForeignKey(orm[u'seo.seosite'], null=False))
        ))
        db.create_unique(m2m_table_name, ['page_id', 'seosite_id'])

    def backwards(self, orm):
        # Deleting field 'Page.name'
        db.delete_column(u'myblocks_page', 'name')

        # Removing M2M table for field sites on 'Page'
        db.delete_table(db.shorten_name(u'myblocks_page_sites'))
    ...
    models = {
        ...
        u'myblocks.page': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'temp'", 'to': u"orm['seo.SeoSite']"}),
