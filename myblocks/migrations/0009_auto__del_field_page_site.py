...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'myblocks_page', 'site_id')


    def backwards(self, orm):
        # Adding field 'Page.site'
        db.add_column(u'myblocks_page', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='temp', to=orm['seo.SeoSite']),
                      keep_default=False)
