...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'myblocks_page', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ColumnBlockOrder.updated'
        db.add_column(u'myblocks_columnblockorder', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Row.updated'
        db.add_column(u'myblocks_row', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'BlockOrder.updated'
        db.add_column(u'myblocks_blockorder', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Block.updated'
        db.add_column(u'myblocks_block', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'RowOrder.updated'
        db.add_column(u'myblocks_roworder', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 18, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'myblocks_page', 'updated')

        # Deleting field 'ColumnBlockOrder.updated'
        db.delete_column(u'myblocks_columnblockorder', 'updated')

        # Deleting field 'Row.updated'
        db.delete_column(u'myblocks_row', 'updated')

        # Deleting field 'BlockOrder.updated'
        db.delete_column(u'myblocks_blockorder', 'updated')

        # Deleting field 'Block.updated'
        db.delete_column(u'myblocks_block', 'updated')

        # Deleting field 'RowOrder.updated'
        db.delete_column(u'myblocks_roworder', 'updated')
