...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Search.date_last_accessed'
        db.alter_column(u'api_search', 'date_last_accessed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):

        # Changing field 'Search.date_last_accessed'
        db.alter_column(u'api_search', 'date_last_accessed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
