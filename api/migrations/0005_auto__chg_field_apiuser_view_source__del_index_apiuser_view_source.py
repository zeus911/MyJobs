...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'APIUser.view_source'
        db.alter_column(u'api_apiuser', 'view_source_id', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='view_source_id'))

    def backwards(self, orm):

        # Changing field 'APIUser.view_source'
        db.alter_column(u'api_apiuser', 'view_source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.ViewSource'], null=True))
