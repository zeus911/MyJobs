...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Industry', fields ['industry']
        db.create_index(u'api_industry', ['industry'])

        # Adding index on 'Country', fields ['country']
        db.create_index(u'api_country', ['country'])

        # Adding index on 'CityToCentroidMapping', fields ['city']
        db.create_index(u'api_citytocentroidmapping', ['city'])

        # Adding index on 'CityToCentroidMapping', fields ['state']
        db.create_index(u'api_citytocentroidmapping', ['state'])

        # Adding index on 'Search', fields ['date_last_accessed']
        db.create_index(u'api_search', ['date_last_accessed'])

        # Adding index on 'ZipCodeToCentroidMapping', fields ['zip_code']
        db.create_index(u'api_zipcodetocentroidmapping', ['zip_code'])


    def backwards(self, orm):
        # Removing index on 'ZipCodeToCentroidMapping', fields ['zip_code']
        db.delete_index(u'api_zipcodetocentroidmapping', ['zip_code'])

        # Removing index on 'Search', fields ['date_last_accessed']
        db.delete_index(u'api_search', ['date_last_accessed'])

        # Removing index on 'CityToCentroidMapping', fields ['state']
        db.delete_index(u'api_citytocentroidmapping', ['state'])

        # Removing index on 'CityToCentroidMapping', fields ['city']
        db.delete_index(u'api_citytocentroidmapping', ['city'])

        # Removing index on 'Country', fields ['country']
        db.delete_index(u'api_country', ['country'])

        # Removing index on 'Industry', fields ['industry']
        db.delete_index(u'api_industry', ['industry'])
    ...
    models = {
        ...
        u'api.search': {
            ...
            'date_last_accessed': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
