...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PartnerSavedSearch.account_activation_message'
        db.delete_column(u'mysearches_partnersavedsearch', 'account_activation_message')


    def backwards(self, orm):
        # Adding field 'PartnerSavedSearch.account_activation_message'
        db.add_column(u'mysearches_partnersavedsearch', 'account_activation_message',
