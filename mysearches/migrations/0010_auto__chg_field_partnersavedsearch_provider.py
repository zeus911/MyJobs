...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mysearches_partnersavedsearch', 'provider_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Company']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PartnerSavedSearch.provider'
        db.alter_column(u'mysearches_partnersavedsearch', 'provider_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mydashboard.Company']))
