...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PartnerSavedSearch.partner_message'
        db.delete_column(u'mysearches_partnersavedsearch', 'partner_message')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PartnerSavedSearch.partner_message'
        db.add_column(u'mysearches_partnersavedsearch', 'partner_message',
