...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerSavedSearch.unsubscribed'
        db.add_column(u'mysearches_partnersavedsearch', 'unsubscribed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerSavedSearch.unsubscribed'
        db.delete_column(u'mysearches_partnersavedsearch', 'unsubscribed')
