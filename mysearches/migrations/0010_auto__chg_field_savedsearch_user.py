...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mysearches_savedsearch', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myjobs.User'], null=True, on_delete=models.DO_NOTHING))

    def backwards(self, orm):

        # Changing field 'SavedSearch.user'
        db.alter_column(u'mysearches_savedsearch', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['myjobs.User']))
    ...
    models = {
        ...
        u'mysearches.savedsearch': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['myjobs.User']", 'null': 'True', 'on_delete': 'models.DO_NOTHING'})
        },
