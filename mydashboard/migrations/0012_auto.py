...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mydashboard_companyuser_group', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('companyuser', models.ForeignKey(orm[u'mydashboard.companyuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'mydashboard_companyuser_group', ['companyuser_id', 'group_id'])


    def backwards(self, orm):
        # Removing M2M table for field group on 'CompanyUser'
        db.delete_table('mydashboard_companyuser_group')
