...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('seo_company', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Company.id'
        db.alter_column('seo_company', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
