...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.gravatar'
        db.alter_column(u'myjobs_user', 'gravatar', self.gf('django.db.models.fields.EmailField')(default='', max_length=255))

    def backwards(self, orm):

        # Changing field 'User.gravatar'
        db.alter_column(u'myjobs_user', 'gravatar', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True))
