...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomHomepage.show_signup_form'
        db.add_column(u'myjobs_customhomepage', 'show_signup_form',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomHomepage.show_signup_form'
        db.delete_column(u'myjobs_customhomepage', 'show_signup_form')
