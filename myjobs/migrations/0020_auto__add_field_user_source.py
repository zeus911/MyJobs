...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.source'
        db.add_column(u'myjobs_user', 'source',
                      self.gf('django.db.models.fields.CharField')(default='https://secure.my.jobs', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.source'
        db.delete_column(u'myjobs_user', 'source')
