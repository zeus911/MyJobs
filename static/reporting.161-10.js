...
FilterPage.prototype.load_data = function () {
  ...
  if (this.data[record_type] !== "") {
    ...
    for (i; i < this.data[record_type].length; i++) {
...
Report.prototype.bind_events = function () {
  var report = this;
  $(document.body).on("click", "#next:not(.disabled)", function (e) {
    e.preventDefault();
  ...
  $(document.body).on("click", "#submit_report", function (e) {
    e.preventDefault();
    report.current_page().save_data();
  ...
  $(document.body).on("click", "input[type='checkbox']#all", function () {
  ...
  $(document.body).on("click", "input[type='checkbox']:not(#all)", function () {
    var all_checkboxes = $("#content input:not(#all)"),
...
Report.prototype.next_page = function () {
  ...
  if (next_page instanceof FilterPage) {
    ...
    for (i; i < this.pages.indexOf(next_page); i++) {
...
Report.prototype.submit_report = function () {
  var pages = this.pages,                                     // Array -- Report.pages
